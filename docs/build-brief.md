...
- State: SQLite conversations, inbound events, completed turns, failures,
  outbound Slack delivery attempts, work tasks, scoped task-event timelines,
  governed memory proposals, request-ranked durable memories,
  content-minimizing private-knowledge access records with exact citations, and
  review-gated personal-work runs with durable step evidence.
