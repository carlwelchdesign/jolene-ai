...
- State: SQLite conversations, inbound events, completed turns, failures, outbound Slack delivery attempts, work tasks, governed memory proposals, and approved durable memories with sensitivity, expiry, correction, and forgetting state.
