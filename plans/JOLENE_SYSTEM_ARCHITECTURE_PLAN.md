...
| Remaining boundary | `JOL-CAREER-006` and `PORT-EVAL-001` remain open for lifecycle fixtures, live quality/latency/token/cost evidence, broader red-team coverage, portfolio navigation/accessibility, representative human review, production controls, and launch approval |
